    ...
    <div class="header">
        <div class="header-content">
            <div class="header-left">
                ...
                <!-- Logo Section - END -->
                <!-- School Icon and Name Section - START -->
                <div class="school-icon">🏫</div>
                <h1><%= schoolName %></h1>
                <!-- School Icon and Name Section - END -->
    ...
    <div class="container">
        ...
        <div class="section" style="margin-bottom: 30px;">
            ...
            <div class="grid-3">
                ...
                <a href="<%= request.getContextPath() %>/students-activity.jsp" class="quick-action-card" style="text-decoration: none; color: inherit;">
                    <div class="quick-action-icon">📊</div>
                ...
                <!-- 4. Add Student -->
                <a href="<%= request.getContextPath() %>/add-student.jsp" class="quick-action-card" style="text-decoration: none; color: inherit;">
                    <div class="quick-action-icon">➕</div>
                ...
                <!-- 6. Edit Student -->
                <a href="<%= request.getContextPath() %>/edit-student.jsp" class="quick-action-card" style="text-decoration: none; color: inherit;">
                ...
                <% if (user.getUserType().equals(User.UserType.SCHOOL_COORDINATOR)) { %>
                <a href="<%= request.getContextPath() %>/generate-student-report.jsp" class="quick-action-card" style="text-decoration: none; color: inherit;">
                    <div class="quick-action-icon">📊</div>
                ...
                <!-- 10. Phase-wise Subject Statistics -->
                ...
                <!-- 11. VIDEO UPLOAD -->
                <a href="<%= request.getContextPath() %>/video-upload.jsp" class="quick-action-card" style="text-decoration: none; color: inherit;">
                    <div class="quick-action-icon">🎥</div>
                ...
                <!-- 12. VIEW UPLOADED VIDEOS -->
                <a href="<%= request.getContextPath() %>/view-uploaded-videos.jsp" class="quick-action-card" style="text-decoration: none; color: inherit;">
                    <div class="quick-action-icon">📹</div>
