    ...
    <div class="header">
        <div class="header-content">
            <div class="header-left">
                ...
                <p class="header-subtitle">📍 District Dashboard - <%= districtName %></p>
            </div>
    ...
    <script>
        ...
        function displayStudents(students) {
            ...
            students.forEach((student, index) => {
                ...
                let marathiLevels = [];
                if (student.marathiAksharaLevelText && student.marathiAksharaLevelText !== 'स्तर निश्चित केला नाही') marathiLevels.push('<div style="margin: 3px 0; padding: 4px 6px; background: #e3f2fd; color: #1976d2; border-radius: 3px;"><strong>अक्षर:</strong> ' + escapeHtml(student.marathiAksharaLevelText) + '</div>');
                ...
                html += '<td style="padding: 10px; border: 1px solid #ddd; font-size: 11px;">';
                let mathLevels = [];
                if (student.mathAksharaLevelText && student.mathAksharaLevelText !== 'स्तर निश्चित केला नाही') mathLevels.push('<div style="margin: 3px 0; padding: 4px 6px; background: #f3e5f5; color: #7b1fa2; border-radius: 3px;"><strong>अक्षर:</strong> ' + escapeHtml(student.mathAksharaLevelText) + '</div>');
