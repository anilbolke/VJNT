...
<head>
    ...
    <title>📊 Activity Analysis - <%= divisionLabel %></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<script>var SUPER_DIV = encodeURIComponent('<%= divisionName %>');</script>
    <!-- Top Navigation -->
    <div class="top-nav">
        <a href="super-officer-dashboard.jsp" class="back-btn">
    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <p>Scope: <strong><%= divisionLabel %></strong></p>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            fetch('super-activity-analysis?division=' + SUPER_DIV)
