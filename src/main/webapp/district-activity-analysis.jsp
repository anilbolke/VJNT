...
<body>
    ...
    <script>
            ...
            if (!data.schools || data.schools.length === 0) {
                ...
                data.schools.forEach((school, schoolIndex) => {
                    ...
                    school.phases.forEach((phase, phaseIndex) => {
                        html += '  <div class="phase-content ' + (phaseIndex === 0 ? 'active' : '') + '" id="school' + schoolIndex + '_phase' + phase.phaseNumber + '">';
        ...
        function showPhase(schoolIndex, phaseNumber) {
            // Hide all phase contents for this school
            const school = document.querySelectorAll('.school-card')[schoolIndex];
