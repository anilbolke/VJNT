...
<%
    ...
    if (user == null || !User.UserType.SUPER_DIVISION_OFFICER.equals(user.getUserType())) {
    ...
    // Get statistics for this super division
    
    List<com.vjnt.model.Student> allStudents = studentDAO.getAllStudents();
    ...
    for (com.vjnt.model.Student student : allStudents) {
        ...
        if (division != null) {
            divisionCount.put(division, divisionCount.getOrDefault(division, 0) + 1);
        }
...
<head>
    ...
    <title>Super Division Officer Dashboard - System Overview</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<jsp:include page="academic-year-bar.jsp" />
    <div class="header">
        <div class="header-content">
            <div class="header-left">
                ...
                <h1>Super Division Officer Dashboard</h1>
            ...
            <div class="header-right">
                <div class="user-info-box">
                    ...
                    <div class="user-info">
                        <span>🎭</span>
                        <span><strong>Super Division Officer</strong></span>
                    </div>
                </div>
                    ...
                    <div class="quick-actions-dropdown">
                        ...
                        <div class="dropdown-menu" id="quickActionsMenu">
                            ...
                            <div class="dropdown-section">
                                ...
                                <a href="<%= request.getContextPath() %>/super-manage-announcements.jsp" class="dropdown-item" title="Create and manage announcements for schools">
                                    <span>📢</span>
                            ...
                            <div class="dropdown-section">
                                ...
                                <a href="<%= request.getContextPath() %>/super-analytics-dashboard-enhanced.jsp" class="dropdown-item" title="View detailed analytics and reports">
                                    <span>📊</span>
                                    <span>Analytics Dashboard</span>
                                </a>
                                <a href="<%= request.getContextPath() %>/super-activity-analysis.jsp" class="dropdown-item" title="View activity analysis">
                                    <span>📈</span>
                                    <span>Activity Analysis</span>
                                </a>
                                <a href="<%= request.getContextPath() %>/super-analytics-dashboard.jsp" class="dropdown-item" title="View all analytics in one comprehensive dashboard">
                                    <span>📊</span>
                            ...
                            <div class="dropdown-section">
                                ...
                                <a href="<%= request.getContextPath() %>/super-phase-wise-statistics.jsp" class="dropdown-item" title="View phase-wise subject statistics by district and school">
                                    <span>📚</span>
                                    <span>Phase Levels Statistics</span>
                                </a>
                                <a href="<%= request.getContextPath() %>/super-student-level-jumps.jsp" class="dropdown-item" title="View students with level jumps across all districts">
                                    <span>⚠️</span>
                                    <span>Student Level Jumps</span>
                                </a>
                                <a href="<%= request.getContextPath() %>/super-charts.jsp" class="dropdown-item" title="View interactive charts and analytics for level jumps">
                                    <span>📊</span>
                                    <span>Level Jumps Analytics Charts</span>
                                </a>
                                <a href="<%= request.getContextPath() %>/super-student-level-details.jsp" class="dropdown-item" title="View individual student level details with filters">
                                    <span>👨‍🎓</span>
                                    <span>Student Level Details</span>
                                </a>
                                <a href="<%= request.getContextPath() %>/super-student-levels-percentage.jsp" class="dropdown-item" title="View student levels percentage bar graph by district and school">
                                    <span>📊</span>
                                    <span>Subjects Percentage Graph</span>
                                </a>
                                <a href="<%= request.getContextPath() %>/super-student-level-distribution.jsp" class="dropdown-item" title="View detailed level-wise student distribution with percentage bars">
                                    <span>📈</span>
                                    <span>Level Distribution Graph</span>
                                </a>
                                <a href="<%= request.getContextPath() %>/super-phase-comparison.jsp" class="dropdown-item" title="Compare student levels across Phase 1, 2, 3, and 4 side-by-side">
                                    <span>🔄</span>
    ...
    <div class="container">
        ...
        <div class="breadcrumb">
            <span>Dashboard:</span> <strong>All Divisions</strong>
        </div>
        ...
        function showDistrictSchoolDetails(districtName) {
            ...
            const apiUrl = '<%= request.getContextPath() %>/super-api-schools?district=' + encodeURIComponent(districtName);
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    for (Map.Entry<String, Integer> entry : paginatedDistricts) {
                        ...
                        double percentage = allStudents.size() > 0 ? (totalCount * 100.0 / allStudents.size()) : 0;
                    %>
                    <tr>
    ...
    <script>
        ...
        function loadSchoolContacts() {
            ...
            fetch(contextPath + '/super-contacts-analytics?division=ALL')
                .then(response => response.json())
                .then(data => {
                    if (data.error) {
    ...
    <script>
        ...
        function loadPhaseData(phaseNumber) {
            fetch(contextPath + '/super-analytics?type=phase_completion&division=ALL&phase=' + phaseNumber)
                .then(response => response.json())
                .then(data => {
                    if (data.error) {
                        console.error('Error:', data.error);
