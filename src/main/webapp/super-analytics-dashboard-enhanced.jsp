...
<head>
    ...
    <title>Division Analytics Dashboard - <%= divisionLabel %></title>
...
<script>var SUPER_DIV = encodeURIComponent('<%= divisionName %>');</script>
        ...
        <div class="header-content">
            ...
            <div>
              ...
              <%--   <a href="<%= request.getContextPath() %>/division-student-level-details.jsp" class="btn btn-logout" style="background: #4CAF50;" title="View Student Level Details">
                ...
                <a href="<%= request.getContextPath() %>/super-officer-dashboard.jsp" class="btn btn-logout">Basic View</a>
    ...
    <script>
        ...
        function loadPalakMelavaData() {
            const url = contextPath + '/super-analytics?type=palak_melava&division=' + SUPER_DIV + getDateParams();
        ...
        function loadStudentActivitiesData() {
            const url = contextPath + '/super-analytics?type=student_activities&division=' + SUPER_DIV + getDateParams();
        ...
        function loadPhaseData(phaseNumber) {
            fetch(contextPath + '/super-analytics?type=phase_completion&division=' + SUPER_DIV + '&phase=' + phaseNumber + getDateParams())
                .then(response => response.json())
                .then(data => {
                    if (data.error) {
                        console.error('Error:', data.error);
