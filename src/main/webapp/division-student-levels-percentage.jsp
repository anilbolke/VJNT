...
<head>
    ...
    <title>Student Levels Percentage - <%= divisionName %></title>
...
<body>
        ...
        <div class="header">
            ...
            <div class="header-content">
                ...
                <div class="header-subtitle">
                    Division: <%= divisionName %> | Marathi, Math & English Achievement
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function loadData() {
            ...
            let url = '<%= request.getContextPath() %>/division-student-levels-percentage?division=' + 
        ...
        function exportToCSV() {
            ...
            if (currentView === 'district') {
                ...
                filename = 'district_levels_percentage_' + new Date().toISOString().split('T')[0] + '.csv';
            } else {
