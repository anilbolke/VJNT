...
<%
    ...
    // Auto-generate PEN number for new students
    String autoGeneratedPen = "";
    ...
    // Generate PEN number only for new students (not editing)
    if (!isEdit) {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="info-box">
                <p><strong>📋 Instructions:</strong> System auto-populates <strong>Division, District, and UDISE Number</strong>. <% if (!isEdit) { %><strong>Student PEN is auto-generated</strong> in format TEMPXXXXX (e.g., TEMP12345). <% } %>Fill in all other required fields marked with <span style="color: #f44336;">*</span>.</p>
            </div>
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="studentPen" required 
                                   value="<%= editStudent != null && editStudent.getStudentPen() != null ? editStudent.getStudentPen() : autoGeneratedPen %>" 
                                   <%= !isEdit ? "readonly" : "" %>
                                   placeholder="Auto-generated" 
                                   style="<%= !isEdit ? "background-color: #f0f2f5; cursor: not-allowed;" : "" %>">
                            <% if (!isEdit && !autoGeneratedPen.isEmpty()) { %>
                            <small style="color: #4CAF50; font-size: 12px; margin-top: 5px; display: block;">
                                ✓ PEN auto-generated: <%= autoGeneratedPen %>
                            </small>
                            <% } %>
                        </div>
                    </div>
