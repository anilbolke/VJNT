...
public class GetDivisionStudentLevelsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            sql.append("INNER JOIN schools sch ON s.udise_no = sch.udise_no ");
            sql.append("WHERE s.division = ? AND s.is_active = 1 ");
            
            if (district != null && !district.isEmpty()) {
                sql.append("AND sch.district_name = ? ");
            }
            ...
            sql.append("LIMIT 5000"); // Add limit to prevent excessive data loading
            ...
            while (rs.next()) {
                ...
                // Get phase-specific levels and calculate max in one pass
                ...
                // Calculate current phase based on max level
                ...
                // No EVS, Science, History columns in students table
