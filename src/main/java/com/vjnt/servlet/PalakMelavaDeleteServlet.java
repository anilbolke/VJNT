...
@WebServlet("/palak-melava-delete")
public class PalakMelavaDeleteServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            boolean success = dao.delete(melavaId);
            
            if (success) {
                out.print("{\"success\": true, \"message\": \"Deleted successfully\"}");
            } else {
