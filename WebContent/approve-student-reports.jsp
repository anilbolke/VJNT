    ...
    <div class="container">
        <div class="header">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                ...
                <div class="header-actions">
                    <a href="<%= request.getContextPath() %>/headmaster-dashboard.jsp" class="back-btn" title="Go back to dashboard (or press ESC)">
        ...
        <div class="content">
            ...
            <div class="breadcrumb">
                <a href="<%= request.getContextPath() %>/headmaster-dashboard.jsp">
    ...
    <script>
        ...
        document.addEventListener('keydown', function(event) {
            if (event.key === 'Escape') {
                ...
                if (modals.length === 0) {
                    window.location.href = '<%= request.getContextPath() %>/headmaster-dashboard.jsp';
                }
            }
        });
