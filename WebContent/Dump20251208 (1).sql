...
CREATE TABLE `students` (
  ...
  `marathi_level_text` varchar(100) DEFAULT NULL,
  `math_level_text` varchar(100) DEFAULT NULL,
  `english_level_text` varchar(100) DEFAULT NULL,
  `phase1_marathi_level` varchar(100) DEFAULT NULL,
  `phase1_math_level` varchar(100) DEFAULT NULL,
  `phase1_english_level` varchar(100) DEFAULT NULL,
  `phase2_marathi_level` varchar(100) DEFAULT NULL,
  `phase2_math_level` varchar(100) DEFAULT NULL,
  `phase2_english_level` varchar(100) DEFAULT NULL,
  `phase3_marathi_level` varchar(100) DEFAULT NULL,
  `phase3_math_level` varchar(100) DEFAULT NULL,
  `phase3_english_level` varchar(100) DEFAULT NULL,
  `phase4_marathi_level` varchar(100) DEFAULT NULL,
  `phase4_math_level` varchar(100) DEFAULT NULL,
  `phase4_english_level` varchar(100) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=215793 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-12-08 21:08:41
