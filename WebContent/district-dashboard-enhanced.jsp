...
<head>
    ...
    <title>District Analytics Dashboard - <%= districtName %></title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="chart-grid">
            ...
            <div class="chart-card">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                    <h3 style="margin: 0;">📝 चरण 1 (Phase 1) - School Completion Status</h3>
                    <div class="chart-toggle-buttons">
                ...
                <div class="stats-grid" style="margin-bottom: 15px;">
                    <div class="stat-box">
                        <div class="stat-value" id="phase1TotalSchools">-</div>
            ...
            <div class="chart-card">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                    <h3 style="margin: 0;">📝 चरण 2 (Phase 2) - School Completion Status</h3>
                    <div class="chart-toggle-buttons">
                ...
                <div class="stats-grid" style="margin-bottom: 15px;">
                    <div class="stat-box">
                        <div class="stat-value" id="phase2TotalSchools">-</div>
                        <div class="stat-label">Total Schools</div>
                    </div>
                    <div class="stat-box">
            ...
            <div class="chart-card">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                    <h3 style="margin: 0;">📝 चरण 3 (Phase 3) - School Completion Status</h3>
                    <div class="chart-toggle-buttons">
                ...
                <div class="stats-grid" style="margin-bottom: 15px;">
                    <div class="stat-box">
                        <div class="stat-value" id="phase3TotalSchools">-</div>
                        <div class="stat-label">Total Schools</div>
                    </div>
                    <div class="stat-box">
            ...
            <div class="chart-card">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                    <h3 style="margin: 0;">📝 चरण 4 (Phase 4) - School Completion Status</h3>
                    <div class="chart-toggle-buttons">
                ...
                <div class="stats-grid" style="margin-bottom: 15px;">
                    <div class="stat-box">
                        <div class="stat-value" id="phase4TotalSchools">-</div>
                        <div class="stat-label">Total Schools</div>
                    </div>
                    <div class="stat-box">
    ...
    <script>
        ...
        function loadPalakMelavaData() {
            fetch(contextPath + '/district-analytics?type=palak_melava' + getDateParams())
        ...
        function renderPalakChart(data, chartType) {
            // Use total numbers, not individual schools
        ...
        function loadStudentActivitiesData() {
            fetch(contextPath + '/district-analytics?type=student_activities' + getDateParams())
                .then(response => response.json())
                .then(data => {
                    if (data.error) {
                        console.error('Error:', data.error);
        ...
        function loadPhaseData(phaseNumber) {
            fetch(contextPath + '/district-analytics?type=phase_completion&phase=' + phaseNumber + getDateParams())
                ...
                .then(data => {
                    ...
                    // Update statistics
                    document.getElementById('phase' + phaseNumber + 'TotalSchools').textContent = totalSchools;
        ...
        function renderPhaseChart(phaseNumber, data, chartType) {
            ...
            if (chartType === 'pie') {
                ...
                charts[chartId] = new Chart(ctx, {
                    type: 'bar',
                    data: {
                        labels: ['Total Schools', '100% Complete', 'Incomplete'],
                        datasets: [{
                            label: 'Count',
                            data: [totalSchools, completedSchools, incompleteSchools],
                            backgroundColor: [
                                'rgba(102, 126, 234, 0.7)',
                                'rgba(76, 175, 80, 0.7)',
                                'rgba(255, 193, 7, 0.7)'
