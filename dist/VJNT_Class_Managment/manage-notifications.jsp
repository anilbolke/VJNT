...
<body>
    ...
    <div class="header">
        <div class="header-content">
            ...
            <div class="header-actions">
                <a href="division-dashboard.jsp" class="btn btn-back">
                    ← Back to Dashboard
                </a>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="card">
            <form id="notificationForm" method="post" action="<%= request.getContextPath() %>/save-notification">
    ...
    <div id="editModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999; overflow-y: auto;">
        <div style="max-width: 800px; margin: 50px auto; background: white; border-radius: 15px; padding: 30px; box-shadow: 0 10px 40px rgba(0,0,0,0.3);">
            ...
            <form id="editNotificationForm" method="post" action="<%= request.getContextPath() %>/save-notification">
