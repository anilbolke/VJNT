...
<head>
    ...
    <title>Division Phase-wise Statistics - <%= divisionName %></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>📊 Division Phase-wise Subject Statistics</h1>
            <h1>विभाग टप्पा-निहाय विषय आकडेवारी</h1>
        ...
        <div class="content">
            ...
            <div class="view-tabs">
                <button class="view-tab active" onclick="showView('division')">📊 Division Summary</button>
            ...
            <div id="divisionView" class="view-content active">
                <div class="aggregate-section">
                    <h3>📊 Division-wide Aggregate Statistics</h3>
                    <p style="color: #666; margin-bottom: 20px;">Combined statistics from all schools in <%= divisionName %> Division</p>
    ...
    <script>
        ...
        function loadData() {
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        allData = data;
                        console.log('Schools in data:', data.filteredSchools);
                        console.log('School data keys:', Object.keys(data.schoolData || {}));
                        console.log('District data keys:', Object.keys(data.districtData || {}));
                        console.log('Division summary:', data.divisionSummary);
                        
                        // Check if we have any data
                        if (data.filteredSchools === 0) {
                            console.warn('WARNING: No schools match the current filters!');
                        ...
                        // Show the currently active view (or default to division view)
        ...
        // Populate division summary view
        ...
        function filterData() {
            ...
            console.log('Filter applied - District:', currentFilters.district, 'School:', currentFilters.school, 'Class:', currentFilters.studentClass);
            
            document.getElementById('loadingMessage').style.display = 'block';
            
            // Hide all view-content elements temporarily
        ...
        // Search school function with debouncing
        ...
        function searchSchool() {
            ...
            searchTimeout = setTimeout(() => {
                ...
                // Filter the options in the school dropdown
                const options = schoolFilter.querySelectorAll('option');
                let matchCount = 0;
                let firstMatch = null;
                ...
                // Select first match if found and automatically filter
                if (firstMatch && matchCount === 1) {
                    schoolFilter.value = firstMatch.value;
                    filterData();
                } else if (matchCount === 0) {
                    // No matches found, reset to "All Schools"
                    schoolFilter.value = '';
                } else {
                    // Multiple matches, let user select from dropdown
                    schoolFilter.value = '';
                }
