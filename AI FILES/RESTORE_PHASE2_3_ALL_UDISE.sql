...
-- STEP 0: CHECK CURRENT STATUS BY UDISE - What's missing for each school
-- ============================================================================
SELECT 
    s.udise_no,
    'PHASE 2' as phase,
...
-- ============================================================================
-- STEP 1: COUNT WHAT'S IN AUDIT TABLE - Phase 2
-- ============================================================================
-- Shows for each UDISE how many students have Phase 2 records in audit
SELECT 
    s.udise_no,
...
-- ============================================================================
-- STEP 2: COUNT WHAT'S IN AUDIT TABLE - Phase 3
-- ============================================================================
SELECT 
    s.udise_no,
...
-- ============================================================================
-- STEP 3: RESTORE PHASE 2 DATA FROM AUDIT TABLE - ALL UDISE
-- ============================================================================
...
-- ============================================================================
-- STEP 4: RESTORE PHASE 3 DATA FROM AUDIT TABLE - ALL UDISE
-- ============================================================================
...
-- ============================================================================
-- STEP 5: VERIFY PHASE 2 RESTORATION BY UDISE
-- ============================================================================
-- Shows detailed stats after restoration for each school
SELECT 
    s.udise_no,
...
-- ============================================================================
-- STEP 6: VERIFY PHASE 3 RESTORATION BY UDISE
-- ============================================================================
SELECT 
    s.udise_no,
...
-- ============================================================================
-- STEP 7: CALCULATE PHASE 2 PERCENTAGES BY UDISE AFTER RESTORATION
-- ============================================================================
-- Shows percentage for Phase 2 by each UDISE
SELECT 
    s.udise_no,
    'PHASE 2 %' as phase,
...
-- ============================================================================
-- STEP 8: CALCULATE PHASE 3 PERCENTAGES BY UDISE AFTER RESTORATION
-- ============================================================================
SELECT 
    s.udise_no,
    'PHASE 3 %' as phase,
...
-- ============================================================================
-- STEP 9: SHOW SAMPLE RESTORED RECORDS - Phase 2 (First 5 schools)
-- ============================================================================
SELECT 
...
-- ============================================================================
-- STEP 10: SHOW SAMPLE RESTORED RECORDS - Phase 3 (First 5 schools)
-- ============================================================================
SELECT 
...
-- ============================================================================
-- STEP 11: FINAL SUMMARY - RESTORATION SUCCESS BY UDISE
-- ============================================================================
...
WHERE s.is_active = 1
GROUP BY s.udise_no
HAVING SUM(CASE WHEN s.phase2_marathi IS NOT NULL OR s.phase3_marathi IS NOT NULL THEN 1 ELSE 0 END) > 0
ORDER BY s.udise_no;

-- ============================================================================
-- END OF PHASE 2 & 3 DATA RESTORATION SCRIPT FOR ALL UDISE
-- ============================================================================
...
-- ✅ Percentages recalculated for each UDISE
-- 
-- Expected Results:
-- STEP 5: Each school should show X students with all 3 subjects and dates
-- STEP 6: Each school should show X students with all 3 subjects and dates
-- STEP 7-8: Both phases should show 100% completion (all with dates)
-- STEP 11: Summary showing all schools updated
-- ============================================================================
